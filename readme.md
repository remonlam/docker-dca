...
However it's only supported on a Mac or Windows machine, Linux is not supported. Also make sure you have Google Chrome installed and be able to install the plugin that they use to monitor you remotely and of course you need to have a webcam so they can see you ;-).
